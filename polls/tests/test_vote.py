...
class VotesTest(TestCase):
    ...
    def test_vote_on_recent_question(self):
        ...
        # vote on choice 2
        response = self.client.post(reverse('polls:vote', kwargs={'question_id': self.recent_question.id}), {'choice': choice_2.id})
    ...
    def test_vote_on_past_question(self):
        ...
        # vote on choice 2
        response = self.client.post(reverse('polls:vote', kwargs={'question_id': self.past_question.id}), {'choice': choice_2.id})
    ...
    def test_vote_on_future_question(self):
        ...
        # vote on choice 2
        response = self.client.post(reverse('polls:vote', kwargs={'question_id': self.future_question.id}), {'choice': choice_2.id})
    ...
    def test_not_login_vote(self):
        ...
        # vote on choice 1
        response = self.client.post(reverse('polls:vote', kwargs={'question_id': self.recent_question.id}), {'choice': choice_1.id})
        self.assertEqual(response.status_code, 302)
